...
for(i in 1:18){
  ...
  remDr$navigate("https://www.koreabaseball.com/Record/Team/Pitcher/Basic1.aspx")
  ...
  #morereviews <- remDr$findElement(using = 'id', value = "//*[@id="cphContents_cphContents_cphContents_ddlSeason_ddlSeason"]")
  ...
  remDr$navigate("https://www.koreabaseball.com/Record/Team/Pitcher/Basic2.aspx")
  ...
  temp_df = left_join(data_basic_1_1,data_basic_2_1,by=c("팀명","ERA","순위","season"))
  
  pitcher_team_base_record[[i]] = temp_df[-nrow(temp_df),]
...
write.csv(bind_rows(pitcher_team_base_record),"~/pitcher_team_base_record.csv",row.names = FALSE)
